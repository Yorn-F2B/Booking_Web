...
// Các Route đánh giá dịch vụ mới
Route::get('/danh-gia', [App\Http\Controllers\ReviewController::class, 'index'])->name('reviews.index');
Route::post('/danh-gia', [App\Http\Controllers\ReviewController::class, 'store'])->name('reviews.store');
Route::get('/danh-sach-danh-gia', [App\Http\Controllers\ReviewController::class, 'list'])->name('reviews.list');