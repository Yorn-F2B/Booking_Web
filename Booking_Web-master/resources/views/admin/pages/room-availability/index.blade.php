        ...
        <main class="admin-content">
            ...
            <div class="d-flex justify-content-between align-items-start flex-wrap gap-2 mb-4">
                <div>
                    ...
                    <div class="text-muted small">
                        Dùng cho lễ tân kiểm tra hạng phòng còn trống theo khoảng thời gian khách hỏi.
                    </div>
                </div>
            </div>
            ...
            @if (!empty($searchData['searched']))
                <div class="alert alert-info">
                    ...
                    Hệ thống giữ thêm
                    <strong>{{ $searchData['cleaning_buffer_minutes'] }} phút</strong>
                    sau giờ trả để dọn phòng.
                </div>
