                            ...
                            @forelse ($services as $service)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif ($service->type == 'occupancy_fee')
                                            <span class="badge bg-info text-dark">Phụ thu số người</span>
                                        @elseif ($service->type == 'policy_violation_fee')
                                            <span class="badge bg-dark">Vi phạm nội quy</span>
                                        @else
