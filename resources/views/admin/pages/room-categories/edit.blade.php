        ...
        <form action="{{ route('room-categories.update', $roomCategory->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="settings-section mb-4">
                                ...
                                <div class="col-6 col-md-4 col-xl-3 js-existing-room-image">
                                    <div class="d-block border rounded-3 p-2 h-100 bg-white position-relative">
                                        ...
                                        <a href="{{ asset('storage/' . $image->image) }}" target="_blank">
                                            <img src="{{ asset('storage/' . $image->image) }}" class="w-100 rounded-2"
                                                style="height:140px;object-fit:cover"
                                                onerror="this.closest('.js-existing-room-image').classList.add('border','border-danger')">
                                        </a>
                                        <input class="d-none js-delete-room-image-input" type="checkbox" name="delete_image_ids[]" value="{{ $image->id }}">
                                    </div>
                                </div>
                            @endforeach
                        </div>
                ...
                <div class="mb-3">
                    ...
                    @error('delete_image_ids.*') <small class="text-danger">{{ $message }}</small> @enderror
                </div>
            </div>
