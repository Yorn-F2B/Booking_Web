                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="type" class="form-select">
                                    ...
                                    <option value="service" {{ old('type', $service->type) == 'service' ? 'selected' : '' }}>
                                        Dịch vụ
                                    </option>

                                    <option value="minibar" {{ old('type', $service->type) == 'minibar' ? 'selected' : '' }}>
                                        Minibar
                                    </option>

                                    <option value="damage_fee" {{ old('type', $service->type) == 'damage_fee' ? 'selected' : '' }}>
                                        Phí hư hại
                                    </option>
