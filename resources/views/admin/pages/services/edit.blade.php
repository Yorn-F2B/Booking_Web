    ...
    <div class="admin-wrapper">
        <main class="admin-content">
            ...
            <div class="admin-page-head">
                <div>
                    <h2>Sửa dịch vụ</h2>
                    <p>Cập nhật dịch vụ bán thêm, minibar hoặc phí phát sinh</p>
                </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description" rows="4" class="form-control @error('description') is-invalid @enderror"
                                placeholder="Mô tả cách tính phí, phạm vi hỗ trợ, lưu ý cho lễ tân...">{{ old('description', $service->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
