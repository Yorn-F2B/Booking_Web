        ...
        <main class="admin-content">
            ...
            <div class="admin-page-head">
                <div>
                    ...
                    <p>Gán theo tầng để chia nhanh, hoặc gán trực tiếp từng phòng khi cần kiểm soát chi tiết.</p>
                </div>
            ...
            <div class="row g-3 mb-3">
                <div class="col-lg-6">
                    <div class="settings-section h-100">
                        <h5>Gán theo tầng</h5>
                        <p class="text-muted small">Dùng cho ca làm bình thường. Nhân viên sẽ thấy các phòng cần dọn/kiểm tra thuộc tầng được giao.</p>
                ...
                <div class="col-lg-6">
                    <div class="settings-section h-100">
                        ...
                        <p class="text-muted small">Dùng khi cần giao cụ thể phòng 201, 202... hoặc nhiệm vụ kiểm tra riêng.</p>
                        ...
                        <form action="{{ route('admin.staff-assignments.housekeeping.rooms.store') }}" method="POST" class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="room_ids[]" class="form-select" multiple required size="6">
                                    @foreach ($rooms as $room)
                                        <option value="{{ $room->id }}">
                                            Phòng {{ $room->room_number }} - tầng {{ $room->floor_number }} - {{ $room->category->name ?? 'Không rõ hạng' }}
                                        </option>
                                    @endforeach
                                </select>
