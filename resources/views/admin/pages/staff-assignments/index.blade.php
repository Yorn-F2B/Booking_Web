            ...
            <section class="assignment-hero">
                <div class="d-flex align-items-start justify-content-between gap-3 flex-wrap">
                    <div>
                        ...
                        <p>
                            Chia việc theo đúng nghiệp vụ: lễ tân phụ trách booking, buồng phòng nhận tầng hoặc phòng cụ thể.
                            Role quyết định quyền truy cập; phân công quyết định việc nhân viên được xử lý.
                        </p>
                    </div>
