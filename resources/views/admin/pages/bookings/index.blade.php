                        ...
                        <tbody>
                            @forelse ($bookings as $booking)
                                @php
                                    ...
                                    $canCreateInvoice = in_array($booking->status, ['checked_out', 'completed'], true);
                                    $hasInvoice = \App\Models\Invoice::where('booking_id', $booking->id)->exists();
                                @endphp
                                    ...
                                    <td>
                                        <div class="booking-action-group">
                                            ...
                                            @if ($canCreateInvoice && !$hasInvoice)
                                                <a href="{{ route('admin.invoices.create-from-booking', $booking->id) }}"
                                                    class="btn btn-sm btn-success booking-icon-btn" title="Tạo hóa đơn"
                                                    aria-label="Tạo hóa đơn cho booking {{ $booking->booking_code }}">
                                            ...
                                            @elseif ($hasInvoice)
                                                ...
                                                <a href="{{ route('admin.invoices.show', $invoice) }}"
                                                    class="btn btn-sm btn-info booking-icon-btn" title="Xem hóa đơn"
                                                    aria-label="Xem hóa đơn cho booking {{ $booking->booking_code }}">
                                                    <i class="bx bx-receipt"></i>
                                                </a>
                                            @endif
                                        </div>
