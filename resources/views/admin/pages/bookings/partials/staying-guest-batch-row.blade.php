...
<div class="border rounded-3 p-3 bg-white mb-3 js-batch-guest-row" data-index="{{ $index }}">
    ...
    <div class="row g-2">
        ...
        <div class="col-md-2"><label class="form-label small">Nhóm tuổi <span class="text-danger">*</span></label><select class="form-select form-select-sm" name="guests[{{ $index }}][guest_type]" required><option value="adult">Người lớn</option><option value="child">Trẻ em</option><option value="infant">Em bé</option></select></div>
        ...
        <div class="col-md-3"><label class="form-label small">Số giấy tờ</label><input class="form-control form-control-sm" name="guests[{{ $index }}][document_number]" maxlength="50"></div>
