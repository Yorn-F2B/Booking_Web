            ...
            <div class="bg-white p-4 rounded-3 mb-4 border">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="date" id="startDate" class="form-control" value="{{ $startDate }}" data-no-min data-year-select>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label fw-semibold">Đến ngày</label>
                        <input type="date" id="endDate" class="form-control" value="{{ $endDate }}" data-no-min data-year-select>
                    </div>
                    <div class="col-md-3">
