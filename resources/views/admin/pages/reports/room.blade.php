            ...
            <div class="bg-white p-4 rounded-3 mb-4 border no-print">
                <div class="row g-3 align-items-end">
                    <div class="col-md-2">
                        ...
                        <input type="date" id="reportDate" class="form-control" value="{{ $date }}" data-no-min>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label fw-semibold">Khoảng ngày</label>
                        <div class="input-group">
                            <input type="date" id="reportStartDate" class="form-control" value="{{ $startDate }}" placeholder="Từ" data-no-min>
                            <span class="input-group-text">-</span>
                            <input type="date" id="reportEndDate" class="form-control" value="{{ $endDate }}" placeholder="Đến" data-no-min>
                        </div>
                    </div>
                    <div class="col-md-2">
