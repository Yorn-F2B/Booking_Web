                ...
                <div class="col-lg-4">
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.reviews.hide', $review) }}" method="POST" class="mb-3">
                                @csrf
                                @method('PATCH')
                                <label class="form-label small fw-semibold">Lý do ẩn</label>
                                <textarea name="hidden_reason" class="form-control mb-2" rows="3" maxlength="500"
                                    placeholder="VD: Nội dung không phù hợp, spam...">{{ old('hidden_reason', $review->hidden_reason) }}</textarea>
                            ...
                            <form action="{{ route('admin.reviews.destroy', $review) }}" method="POST"
                                onsubmit="return confirm('Xóa mềm đánh giá này?')">
                                @csrf
                                @method('DELETE')
