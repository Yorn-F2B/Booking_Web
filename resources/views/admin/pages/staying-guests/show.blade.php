    ...
    <main class="admin-content">
        ...
        <div class="admin-page-head d-flex justify-content-between align-items-start gap-3 flex-wrap">
            <div>
                ...
                <p>Booking {{ $booking->booking_code }} · quản lý người đại diện của từng phòng</p>
            </div>
        ...
        @foreach($booking->bookingRooms as $bookingRoom)
            ...
            <div class="settings-section mb-3">
                <div class="d-flex justify-content-between align-items-center gap-2 mb-3 flex-wrap">
                    ...
                    <span class="badge {{ $roomRepresentative ? 'text-bg-success' : 'text-bg-warning' }}">{{ $roomRepresentative ? 'Đã có đại diện' : 'Chưa có đại diện' }}</span>
                </div>
