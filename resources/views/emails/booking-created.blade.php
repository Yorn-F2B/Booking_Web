                            ...
                            <div style="border:1px solid #e5e7eb;border-radius:14px;overflow:hidden;margin-bottom:18px;">
                                <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding:12px 14px;text-align:right;font-weight:700;border-top:1px solid #eef2f7;">{{ $booking->adult_count }} NL / {{ $booking->child_count }} TE / {{ $booking->baby_count ?? 0 }} EB · {{ $booking->room_quantity }} phòng</td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            @if ($manualRoomSelection)
                                <div style="border:1px solid #f59e0b;background:#fffbeb;border-radius:14px;padding:14px;margin-bottom:18px;font-size:14px;line-height:1.6;">
                                    ...
                                    @elseif ($roomSelectionStatus === 'fulfilled')
                                        Yêu cầu đã được đáp ứng. Phí đảm bảo yêu cầu phòng: <strong>{{ number_format((float) ($booking->room_selection_fee ?? 0), 0, ',', '.') }}đ</strong>.
                                    ...
                                    @elseif ($roomSelectionStatus === 'unfulfilled')
