                ...
                <table width="640" cellpadding="0" cellspacing="0" style="max-width:640px;width:100%;background:#ffffff;border-radius:18px;overflow:hidden;border:1px solid #e5e7eb;">
                    <tr>
                        <td style="background:#0f172a;color:#ffffff;padding:22px 24px;">
                            ...
                            <div style="font-size:24px;font-weight:800;margin-top:6px;">{{ $emailTitle }}</div>
                            <div style="font-size:14px;color:#cbd5e1;margin-top:6px;">Mã booking: <strong>{{ $booking->booking_code }}</strong></div>
                        </td>
                    </tr>
                            ...
                            @elseif ($latestPendingPayment)
                                <div style="background:#fff7ed;border:1px solid #fed7aa;border-radius:14px;padding:14px 16px;margin-bottom:18px;color:#7c2d12;">
                                    ...
                                    <div style="font-size:14px;line-height:1.6;">
                                        ...
                                        Booking chỉ được xác nhận chính thức sau khi hệ thống ghi nhận thanh toán thành công.
                                    </div>
                                </div>
                    ...
                    <tr>
                        <td style="background:#f8fafc;border-top:1px solid #e5e7eb;padding:16px 24px;color:#64748b;font-size:12px;line-height:1.6;">
                            Email này được gửi tự động từ hệ thống MCuong Hotel. Vui lòng không trả lời trực tiếp email này nếu không có người phụ trách hộp thư.
                        </td>
                    </tr>
                </table>
            </td>
