...
<table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#fff;border:1px solid #e2e8f0;border-radius:12px;overflow:hidden">
    ...
    <tr><td style="padding:26px">
        <p style="margin:0 0 18px;line-height:1.6">Booking <strong>{{ $booking->booking_code }}</strong> đã được hủy thành công.</p>
        <table width="100%" cellpadding="11" cellspacing="0" style="border-collapse:collapse;border:1px solid #e5e9e7;border-radius:10px">
            <tr><td style="color:#66736f">Khách hàng</td><td align="right"><strong>{{ $booking->booked_customer_name }}</strong></td></tr>
            <tr><td style="color:#66736f;border-top:1px solid #edf0ef">Đã thanh toán</td><td align="right" style="border-top:1px solid #edf0ef"><strong>{{ number_format($paidAmount,0,',','.') }}đ</strong></td></tr>
            ...
            <tr><td style="color:#66736f;border-top:1px solid #edf0ef">Lý do</td><td align="right" style="border-top:1px solid #edf0ef"><strong>{{ $reason }}</strong></td></tr>
        </table>
