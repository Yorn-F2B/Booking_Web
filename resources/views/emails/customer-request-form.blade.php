...
<table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#fff;border:1px solid #e2e8f0;border-radius:12px;overflow:hidden">
    ...
    <tr><td style="padding:26px">
        <p style="margin:0 0 10px;line-height:1.6">Booking <strong>{{ $booking->booking_code }}</strong></p>
        ...
        <a href="{{ $formUrl }}" style="display:inline-block;background:#0a1931;color:#fff;padding:12px 18px;border-radius:7px;text-decoration:none;font-weight:700">Mở biểu mẫu</a>
        <p style="margin:18px 0 0;color:#75817d;font-size:12px">Liên kết hết hạn lúc {{ $expiresAt->timezone('Asia/Ho_Chi_Minh')->format('d/m/Y H:i') }}.</p>
    </td></tr>
</table>
</td></tr></table>
</body></html>
