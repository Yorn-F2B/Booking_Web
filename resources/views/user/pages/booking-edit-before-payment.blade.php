            ...
            <div>
                <section class="prepay-card">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-2"><label class="prepay-label" for="baby_count">Em bé</label><input type="number" min="0" max="{{ (int) app(\App\Services\HotelPolicyService::class)->get('booking.max_online_guests', 60) }}" class="form-control @error('baby_count') is-invalid @enderror" id="baby_count" name="baby_count" value="{{ old('baby_count', $booking->baby_count ?? 0) }}">@error('baby_count')<div class="invalid-feedback">{{ $message }}</div>@enderror</div>
