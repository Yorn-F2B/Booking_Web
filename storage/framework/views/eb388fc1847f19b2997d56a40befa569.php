...
<head>
    <meta charset="UTF-8">
    <title>Báo cáo doanh thu — <?php echo e($periodLabel); ?></title>
    <style>
...
<div class="header">
    <h1>MCuong Hotel &mdash; Báo cáo doanh thu &mdash; <?php echo e($periodLabel); ?></h1>
    <p>Xuất lúc <?php echo e($generatedAt); ?></p>
</div>
        ...
        <tr>
            <td>
                <div class="summary-card">
                    <div class="val"><?php echo e(number_format($totalBookings)); ?></div>
                    <div class="lbl">Tổng booking</div>
                </div>
            </td>
            <td>
                <div class="summary-card">
                    <div class="val green"><?php echo e(number_format($totalRevenue, 0, ',', '.')); ?>đ</div>
                    <div class="lbl">Tổng doanh thu</div>
                </div>
            </td>
            <td>
                <div class="summary-card">
                    <div class="val blue"><?php echo e(number_format($totalPaid, 0, ',', '.')); ?>đ</div>
                    <div class="lbl">Đã thu</div>
                </div>
            </td>
            <td>
                <div class="summary-card">
                    <div class="val orange"><?php echo e(number_format($totalPending, 0, ',', '.')); ?>đ</div>
...
<div class="section">
    ...
    <table class="data table-year">
        ...
        <tbody>
            <?php $__currentLoopData = $monthlyData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td><?php echo e($row['month']); ?></td>
                <td class="tc"><?php echo e($row['bookings']); ?></td>
                <td class="tr"><?php echo e(number_format($row['revenue'], 0, ',', '.')); ?>đ</td>
                <td class="tr"><?php echo e(number_format($row['paid'], 0, ',', '.')); ?>đ</td>
                <td class="tr"><?php echo e(number_format($row['pending'], 0, ',', '.')); ?>đ</td>
                <td class="tr"><?php echo e($row['revenue'] > 0 ? number_format($row['paid'] / $row['revenue'] * 100, 1) : '0.0'); ?>%</td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <tr class="total-row">
                <td>Tổng cộng</td>
                <td class="tc"><?php echo e($totalBookings); ?></td>
                <td class="tr"><?php echo e(number_format($totalRevenue, 0, ',', '.')); ?>đ</td>
                <td class="tr"><?php echo e(number_format($totalPaid, 0, ',', '.')); ?>đ</td>
                <td class="tr"><?php echo e(number_format($totalPending, 0, ',', '.')); ?>đ</td>
                <td class="tr"><?php echo e($totalRevenue > 0 ? number_format($totalPaid / $totalRevenue * 100, 1) : '0.0'); ?>%</td>
            </tr>
        </tbody>
    </table>
</div>
...
<?php if(in_array($mode, ['month', 'range']) && $dailyData): ?>
<div class="section">
    ...
    <table class="data table-daily">
        ...
        <tbody>
            <?php $hasAny = collect($dailyData)->sum('bookings') > 0; ?>
            ...
            <?php if($hasAny && $row['bookings'] == 0): ?> <?php continue; ?> <?php endif; ?>
            <tr>
                <td><?php echo e($row['date']); ?></td>
                <td class="tc"><?php echo e($row['bookings']); ?></td>
                <td class="tr"><?php echo e(number_format($row['revenue'], 0, ',', '.')); ?>đ</td>
                <td class="tr"><?php echo e(number_format($row['paid'], 0, ',', '.')); ?>đ</td>
                <td class="tr"><?php echo e(number_format(max(0, $row['revenue'] - $row['paid']), 0, ',', '.')); ?>đ</td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <tr class="total-row">
                <td>Tổng cộng</td>
...
<?php if($categoryData->isNotEmpty()): ?>
<div class="section">
    ...
    <table class="data table-category">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="tc"><?php echo e($cat['bookings']); ?></td>
                <td class="tr"><?php echo e(number_format($cat['revenue'], 0, ',', '.')); ?>đ</td>
                <td class="tr"><?php echo e($totalRevenue > 0 ? number_format($cat['revenue'] / $totalRevenue * 100, 1) : '0.0'); ?>%</td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
    </table>
...
<?php /**PATH C:\xampp\htdocs\Booking_Web-master\Booking_Web-master\resources\views\admin\pages\reports\pdf.blade.php ENDPATH**/ ?>