...
<details class="compact-panel mb-3" id="stayingGuestsPanel" <?php if($errors->any()): ?> open <?php endif; ?>>
    <summary>
        ...
        <span class="badge-clean <?php echo e($roomsMissingAdultRepresentative === 0 && $booking->bookingRooms->isNotEmpty() ? 'status-done' : 'status-warning'); ?>">
            <?php echo e($declaredTotal); ?> hồ sơ · <?php echo e($roomsMissingAdultRepresentative); ?> phòng thiếu đại diện người lớn
        </span>
    </summary>
        ...
        <div class="row g-2 mb-3">
            <div class="col-md-4">
                <div class="border rounded p-2 h-100">
                    ...
                    <strong><?php echo e($booking->adult_count); ?> NL / <?php echo e($booking->child_count); ?> TE / <?php echo e($booking->baby_count ?? 0); ?> EB · <?php echo e($actualTotal); ?> người</strong>
                </div>
            </div>
            <div class="col-md-4">
                <div class="border rounded p-2 h-100">
                    <div class="text-muted small">Hồ sơ đã khai</div>
                    <strong><?php echo e($declaredAdults); ?> NL / <?php echo e($declaredChildren); ?> TE / <?php echo e($declaredInfants); ?> EB · <?php echo e($declaredTotal); ?> hồ sơ</strong>
                </div>
            </div>
            <div class="col-md-4">
                <div class="border rounded p-2 h-100">
            ...
            <details class="border rounded mb-3 overflow-hidden <?php echo e($isRoomOverCapacity ? 'border-danger' : ''); ?>" <?php if($errors->any()): ?> open <?php endif; ?>>
                <summary class="px-3 py-2 bg-light" style="cursor:pointer">
                    <span class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                        ...
                        <span class="badge <?php echo e($isRoomOverCapacity || $missingAdultRepresentative ? 'text-bg-warning' : 'text-bg-light border'); ?>">
                            <?php echo e($roomActualTotal); ?> khách thực tế · <?php echo e($roomActualAdults); ?>/<?php echo e($adultCapacity); ?> NL · <?php echo e($roomActualMinors); ?>/<?php echo e($childCapacity); ?> TE/EB · <?php echo e($roomGuests->count()); ?> hồ sơ
                        </span>
                    </span>
                </summary>

                <div class="p-3 border-top">
                    <?php if($missingAdultRepresentative): ?>
...
<?php if (! $__env->hasRenderedOnce('7e59dce2-98d6-4316-8a03-5de19a1d0f20')): $__env->markAsRenderedOnce('7e59dce2-98d6-4316-8a03-5de19a1d0f20'); ?>
<style>
