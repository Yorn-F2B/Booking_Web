...
<details class="compact-panel mb-3" id="stayingGuestsPanel">
    ...
    <div class="compact-panel-body">
        ...
        <?php $__currentLoopData = $booking->bookingRooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bookingRoom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            ?>
            <div class="border rounded mb-3 overflow-hidden <?php echo e($isRoomOverCapacity ? 'border-danger' : ''); ?>">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $roomGuests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <details class="border rounded mb-2">
                            <summary class="px-3 py-2 d-flex justify-content-between align-items-center gap-2">
                                ...
                                <span class="small text-muted"><?php echo e($guest->display_document ?: ($documentTypeLabels[$guest->document_type] ?? 'Chưa có giấy tờ')); ?></span>
                            </summary>
...
<?php if (! $__env->hasRenderedOnce('7c4e5a83-5521-4850-b48c-221e3df2734f')): $__env->markAsRenderedOnce('7c4e5a83-5521-4850-b48c-221e3df2734f'); ?>
<script>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Booking_Web-master\Booking_Web-master\resources\views\admin\pages\bookings\partials\staying-guests.blade.php ENDPATH**/ ?>