            ...
            <div class="col-xl-4">
                ...
                <?php if($leaderStatus === 'guest_accepted'): ?>
                    ...
                    >
                                        ...
                                        <div class="promo-scroll">
                                            <?php $__currentLoopData = $promotions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promotion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <label class="promo-row">
                                                    ...
                                                    >
                                                    <strong><?php echo e($promotion->code); ?></strong>
                                                    <span><?php echo e($promotion->name); ?></span>
                        ...
                        <textarea name="admin_note" class="form-control" rows="4" required><?php echo e(old('admin_note', $leader->admin_note)); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Booking_Web-master\Booking_Web-master\resources\views\admin\pages\room-issues\group-show.blade.php ENDPATH**/ ?>