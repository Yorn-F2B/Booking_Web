                            ...
                            <table class="table table-bordered align-middle">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $roomInspection->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td><strong><?php echo e($item->name); ?></strong><div class="small text-muted"><?php echo e($item->type === 'minibar' ? 'Minibar/đồ dùng' : 'Hư hại/mất đồ'); ?></div></td>
                                            ...
                                            <td>
                                                <?php if($item->status === 'approved'): ?><span class="badge bg-success">Đã duyệt <?php echo e(number_format((float) $item->total, 0, ',', '.')); ?>đ</span>
                                                <?php elseif($item->status === 'rejected'): ?><span class="badge bg-secondary">Không duyệt</span><div class="small"><?php echo e($item->admin_note); ?></div>
                                                <?php else: ?> <span class="text-muted">Chưa duyệt</span><?php endif; ?>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Booking_Web-master\Booking_Web-master\resources\views\admin\pages\floor-inspections\show.blade.php ENDPATH**/ ?>