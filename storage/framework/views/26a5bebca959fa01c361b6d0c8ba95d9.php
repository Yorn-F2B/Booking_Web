                    ...
                    <div class="row g-2 align-items-end">
                        ...
                        <div class="col-12 d-flex justify-content-between align-items-center gap-2 flex-wrap mt-3">
                            <div class="booking-muted-line">
                                <?php if(request()->hasAny(['keyword', 'status', 'payment_status', 'date_from', 'date_to', 'time_from', 'time_to', 'filter_date'])): ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Booking_Web-master\Booking_Web-master\resources\views\admin\pages\bookings\index.blade.php ENDPATH**/ ?>