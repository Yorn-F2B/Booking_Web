    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if(!empty($searchData['check_in_date']) && !empty($searchData['check_out_date'])): ?>
                <div class="alert alert-info">
                    ...
                    <strong><?php echo e($searchData['check_in_time'] ?? '14:00'); ?></strong>
                    ngày <strong><?php echo e(date('d/m/Y', strtotime($searchData['check_in_date']))); ?></strong>
                    đến
                    <strong><?php echo e($searchData['check_out_time'] ?? '12:00'); ?></strong>
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\Booking_Web-master (1)\Booking_Web-master\resources\views/user/pages/rooms.blade.php ENDPATH**/ ?>