...
<?php $__env->startSection('content'); ?>
    ...
    <div id="adminChatRoot" class="admin-wrapper chat-page"
        ...
        <main class="admin-content">
            ...
            <div class="alert alert-danger"><?php echo e(session('error')); ?></div> <?php endif; ?>
            <?php if($errors->any()): ?>
                    ...
                    <?php if($selectedConversation): ?>
                        ...
                        ?? 'Chưa có thông tin liên hệ'); ?>
                                    ...
                                    <div class="d-flex gap-2">
                                        <?php if($selectedConversation->status === 'waiting' && !$selectedConversation->assigned_staff_id): ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Booking_Web-master\Booking_Web-master\resources\views\admin\pages\chats\index.blade.php ENDPATH**/ ?>