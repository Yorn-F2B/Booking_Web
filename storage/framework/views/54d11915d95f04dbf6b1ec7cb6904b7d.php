...
<head>
    ...
    <title><?php echo e($notificationTitle); ?></title>
</head>
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;background:#ffffff;border:1px solid #e5e7eb;border-radius:14px;overflow:hidden;">
                ...
                <tr>
                    <td style="padding:28px 26px;">
                        <h1 style="margin:0 0 14px;font-size:22px;line-height:1.35;color:#111827;"><?php echo e($notificationTitle); ?></h1>
                        <p style="margin:0;font-size:15px;line-height:1.7;color:#4b5563;"><?php echo e($notificationMessage); ?></p>

                        <?php if($targetUrl): ?>
                            <p style="margin:24px 0 0;">
                                <a href="<?php echo e($targetUrl); ?>" style="display:inline-block;padding:11px 18px;border-radius:9px;background:#c99a25;color:#ffffff;text-decoration:none;font-weight:700;">Xem chi tiết</a>
                            </p>
                        <?php endif; ?>
                    </td>
                </tr>
...
<?php /**PATH C:\xampp\htdocs\booking-web\resources\views/emails/operational-notification.blade.php ENDPATH**/ ?>