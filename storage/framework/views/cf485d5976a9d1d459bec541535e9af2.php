...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Tra cứu booking'); ?> - MCuong Hotel</title>
...
<div class="wrap"><div class="card">
    <div class="head"><div class="brand">MCuong Hotel</div><h1><?php echo $__env->yieldContent('heading'); ?></h1><p><?php echo $__env->yieldContent('subheading'); ?></p></div>
    <div class="body">
...
<?php /**PATH C:\xampp\htdocs\Booking_Web-master\Booking_Web-master\resources\views\guest-bookings\layout.blade.php ENDPATH**/ ?>