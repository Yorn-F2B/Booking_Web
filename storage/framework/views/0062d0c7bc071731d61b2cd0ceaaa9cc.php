    ...
    <div class="admin-wrapper">
        ...
        <main class="admin-content">
            ...
            <p class="admin-breadcrumb mb-3">
                ...
                <a href="<?php echo e(route('admin.customers.show', $customer)); ?>"><?php echo e($customer->first_name); ?> <?php echo e($customer->last_name); ?></a> / 
                Chỉnh sửa
            </p>
...
unset($__errorArgs, $__bag); ?>" required>
                                <option value="active" <?php echo e(old('status', $customer->status) === 'active' ? 'selected' : ''); ?>>Hoạt động</option>
                                <option value="blacklist" <?php echo e(old('status', $customer->status) === 'blacklist' ? 'selected' : ''); ?>>Blacklist</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>" 
                                      rows="3"><?php echo e(old('note', $customer->note)); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Booking_Web-master\Booking_Web-master\resources\views\admin\pages\customers\edit.blade.php ENDPATH**/ ?>