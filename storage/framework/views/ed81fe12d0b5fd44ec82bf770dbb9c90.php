...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?php
                                            $bookingBirthday = old('birthday', $customer?->birthday ? \Carbon\Carbon::parse($customer->birthday)->format('Y-m-d') : '');
                                        ?>
                                        <input type="date" name="birthday" class="form-control"
                                            value="<?php echo e($bookingBirthday); ?>"
                                            min="1900-01-01"
                                            max="<?php echo e(now('Asia/Ho_Chi_Minh')->subYears(18)->toDateString()); ?>"
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Booking_Web-master\Booking_Web-master\resources\views\user\pages\booking-confirm.blade.php ENDPATH**/ ?>