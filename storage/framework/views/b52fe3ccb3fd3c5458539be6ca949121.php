...
<head>
    <meta charset="UTF-8">
    <title>Báo cáo tình trạng phòng — <?php echo e($periodLabel); ?></title>
    <style>
...
<div class="header">
    <h1>MCuong Hotel &mdash; Báo cáo tình trạng phòng &mdash; <?php echo e($periodLabel); ?></h1>
...
<div class="section">
    ...
    <table class="data">
        <tr>
            <td><strong>Tầng:</strong> <?php echo e($floorLabel); ?></td>
            <td><strong>Hạng phòng:</strong> <?php echo e($categoryLabel); ?></td>
            <td><strong>Trạng thái:</strong> <?php echo e($statusLabel); ?></td>
        </tr>
    </table>
</div>
        ...
        <tr>
            <td>
                <div class="summary-card">
                    <div class="val"><?php echo e($totalRooms); ?></div>
                    <div class="lbl">Tổng số phòng</div>
                </div>
            </td>
            <td>
                <div class="summary-card">
                    <div class="val green"><?php echo e($availableRooms); ?></div>
                    <div class="lbl">Phòng trống</div>
                </div>
            </td>
            <td>
                <div class="summary-card">
                    <div class="val blue"><?php echo e($reservedRooms); ?></div>
                    <div class="lbl">Phòng đã đặt</div>
                </div>
            </td>
            <td>
                <div class="summary-card">
                    <div class="val orange"><?php echo e($occupiedRooms); ?></div>
                    <div class="lbl">Phòng đang ở</div>
                </div>
            </td>
            <td>
                <div class="summary-card">
                    <div class="val"><?php echo e($cleaningRooms); ?></div>
                    <div class="lbl">Phòng đang dọn</div>
                </div>
            </td>
            <td>
                <div class="summary-card">
                    <div class="val red"><?php echo e($maintenanceRooms); ?></div>
    ...
    <table class="data">
        <tr>
            <td style="padding: 15px;">
                <span style="font-size: 24px; font-weight: 800; color: <?php echo e($occupancyRate >= 80 ? '#16a34a' : ($occupancyRate >= 50 ? '#d97706' : '#dc2626')); ?>;">
                    <?php echo e($occupancyRate); ?>%
                </span>
                <span style="font-size: 12px; color: #64748b; margin-left: 10px;">
                    Khách sạn đang kín <?php echo e($occupancyRate); ?>%
                </span>
            </td>
        </tr>
    </table>
    ...
    <table class="data table-category">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="tc"><?php echo e($stat['total']); ?></td>
                <td class="tc"><?php echo e($stat['occupied']); ?></td>
                <td class="tc"><?php echo e($stat['reserved']); ?></td>
                <td class="tc"><?php echo e($stat['available']); ?></td>
                <td class="tc"><?php echo e($stat['cleaning']); ?></td>
                <td class="tc"><?php echo e($stat['maintenance']); ?></td>
                <td class="tc"><?php echo e($stat['occupancy_rate']); ?>%</td>
            </tr>
    ...
    <table class="data table-room">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo e($statuses[$room['status']] ?? $room['status']); ?></td>
...
<?php /**PATH C:\xampp\htdocs\Booking_Web-master\Booking_Web-master\resources\views\admin\pages\reports\room-pdf.blade.php ENDPATH**/ ?>