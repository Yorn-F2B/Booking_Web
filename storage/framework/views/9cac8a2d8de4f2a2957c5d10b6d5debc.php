    ...
    <div class="admin-wrapper">
        <main class="admin-content">
            ...
            <p class="admin-breadcrumb mb-3">
                <a href="<?php echo e(route('services.index')); ?>">Admin</a> / Sửa dịch vụ
            </p>

            <div class="admin-page-head">
                <div>
                    <h2>Sửa dịch vụ</h2>
                    <p>Cập nhật dịch vụ, minibar gọi thêm, minibar kiểm kê hoặc phí phát sinh</p>
                </div>
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('name', $service->name)); ?>" placeholder="Ví dụ: Gửi ô tô qua đêm">
...
unset($__errorArgs, $__bag); ?>">
                                <?php $__currentLoopData = $typeLabels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $typeValue => $typeLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($typeValue); ?>" <?php echo e(old('type', $service->type) == $typeValue ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                                <?php $__currentLoopData = $groupLabels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupValue => $groupLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($groupValue); ?>" <?php echo e(old('service_group', $service->service_group ?? 'general') == $groupValue ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('price', $service->price)); ?>" min="0" step="1000" placeholder="Ví dụ: 100000">
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('unit', $service->unit)); ?>" placeholder="lần, đêm, giờ, chiếc...">
...
unset($__errorArgs, $__bag); ?>">
                                <?php $__currentLoopData = $billingRuleLabels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ruleValue => $ruleLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($ruleValue); ?>" <?php echo e(old('billing_rule', $service->billing_rule ?? 'once') == $ruleValue ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                                <option value="active" <?php echo e(old('status', $service->status) == 'active' ? 'selected' : ''); ?>>
                                    Hoạt động
                                </option>
                                <option value="inactive" <?php echo e(old('status', $service->status) == 'inactive' ? 'selected' : ''); ?>>
                                    Tạm ẩn
                                </option>
                            </select>
...
unset($__errorArgs, $__bag); ?>"
                                placeholder="Mô tả dịch vụ"><?php echo e(old('description', $service->description)); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Booking_Web-master\Booking_Web-master\resources\views\admin\pages\services\edit.blade.php ENDPATH**/ ?>