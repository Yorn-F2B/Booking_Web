...
unset($__errorArgs, $__bag); ?>"
                                                value="<?php echo e($bdVal); ?>" min="1900-01-01" max="<?php echo e(now('Asia/Ho_Chi_Minh')->subYears(18)->format('Y-m-d')); ?>">
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Booking_Web-master\Booking_Web-master\resources\views/user/pages/user-settings.blade.php ENDPATH**/ ?>