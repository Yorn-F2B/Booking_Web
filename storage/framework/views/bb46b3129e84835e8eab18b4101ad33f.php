    ...
    <main class="py-5">
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-8">
                    <form action="<?php echo e(route('bookings.reviews.store', $booking)); ?>" method="POST" class="card border-0 shadow-sm">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Booking_Web-master\Booking_Web-master\resources\views\user\reviews\create.blade.php ENDPATH**/ ?>