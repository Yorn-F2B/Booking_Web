...
<?php $__env->startSection('content'); ?>
                                ...
                                <div class="row g-2 mb-3">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" name="check_in_date" id="home_check_in_date"
                                            ...
                                            value="<?php echo e(request('check_in_date') && request('check_in_date') >= $minOnlineCheckInDate ? request('check_in_date') : ''); ?>"
                                            required>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" name="check_out_date" id="home_check_out_date"
                                            ...
                                            value="<?php echo e(request('check_out_date') && request('check_out_date') >= $minOnlineCheckOutDate ? request('check_out_date') : ''); ?>"
                                            required>
                                    </div>
    ...
    <?php $__currentLoopData = $featuredRoomCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option value="<?php echo e($category->id); ?>"
            data-adult-capacity="<?php echo e((int) $category->adult_capacity); ?>"
            data-child-capacity="<?php echo e((int) $category->child_capacity); ?>"
            <?php echo e((string) request('room_category_id') === (string) $category->id ? 'selected' : ''); ?>>
    ...
    <section class="py-5 bg-light">
        <div class="container">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="<?php echo e(route('rooms')); ?>" class="btn btn-outline-primary d-none d-md-inline-flex" data-aos="fade-left">
                    Xem tất cả phòng
                </a>
            ...
            <div class="swiper roomsSwiper" data-aos="fade-up">
                ...
                <div class="swiper-wrapper">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $featuredRoomCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <article class="card room-card h-100 border-0 shadow-sm">
                                ...
                                <div class="ratio ratio-4x3">
                                    ...
                                    <?php if($category->thumbnail): ?>
                                        ...
                                        <img src="<?php echo e(asset('storage/' . $category->thumbnail)); ?>" class="card-img-top"
                                            alt="<?php echo e($category->name); ?>" style="object-fit: cover;">

                                    <?php elseif($category->images->count()): ?>

                                        <img src="<?php echo e(asset('storage/' . $category->images->first()->image)); ?>" class="card-img-top"
                                            alt="<?php echo e($category->name); ?>" style="object-fit: cover;">
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="amenity-list mb-3">
                                        ...
                                        <?php $__empty_2 = true; $__currentLoopData = $category->amenities->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $amenity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\Booking_Web-master (1)\Booking_Web-master\resources\views/user/pages/home.blade.php ENDPATH**/ ?>