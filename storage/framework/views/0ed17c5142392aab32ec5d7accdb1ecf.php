...
<div class="border rounded-3 p-3 bg-white mb-3 js-batch-guest-row" data-index="<?php echo e($index); ?>">
    ...
    <input type="hidden" name="guests[<?php echo e($index); ?>][no_document_acknowledged]" value="0" data-no-document-ack>
    <input type="hidden" name="guests[<?php echo e($index); ?>][no_document_reason]" value="" data-no-document-reason>
    <div class="row g-2">
        ...
        <div class="col-md-2">
            ...
            <select class="form-select form-select-sm js-guest-type" name="guests[<?php echo e($index); ?>][guest_type]" required>
        ...
        <div class="col-md-2"><label class="form-label small">Loại giấy tờ</label><select class="form-select form-select-sm js-document-type" name="guests[<?php echo e($index); ?>][document_type]"><option value="cccd">CCCD</option><option value="passport">Hộ chiếu</option><option value="birth_certificate">Giấy khai sinh</option><option value="personal_id">Mã định danh</option><option value="other">Khác</option><option value="none">Chưa có</option></select></div>
        <div class="col-md-3"><label class="form-label small">Số giấy tờ</label><input class="form-control form-control-sm js-document-number" name="guests[<?php echo e($index); ?>][document_number]" maxlength="50"></div>
...
<?php /**PATH C:\xampp\htdocs\booking-web\resources\views/admin/pages/bookings/partials/staying-guest-batch-row.blade.php ENDPATH**/ ?>