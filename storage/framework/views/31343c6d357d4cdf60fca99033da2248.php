    ...
    <div class="row g-4">
      ...
      <div class="col-lg-2 col-md-3 col-6">
        ...
        <ul class="list-unstyled small mb-0" style="line-height:2">
          ...
          <li><a href="<?php echo e(url('rooms')); ?>">Hạng phòng</a></li>
      ...
      <div class="col-lg-2 col-md-3 col-6">
        ...
        <ul class="list-unstyled small mb-0" style="line-height:2">
          ...
          <li><a href="<?php echo e(url('user-settings')); ?>">Cài đặt</a></li>
          <li><a href="<?php echo e(url('booking-history')); ?>">Lịch sử đặt phòng</a></li>
          <li><a href="<?php echo e(route('guest-bookings.index')); ?>">Tra cứu booking vãng lai</a></li>
        </ul>
      </div>
      <div class="col-lg-4 col-md-6">
        ...
        <ul class="list-unstyled small mb-0" style="line-height:2;color:rgba(255,255,255,.55)">
          <li><i class="bx bx-time me-1 text-gold"></i> Nhận phòng chuẩn: <?php echo e($footerCheckIn); ?> · linh hoạt từ <?php echo e($footerEarlyFreeFrom); ?> nếu phòng sẵn sàng</li>
          <li><i class="bx bx-time me-1 text-gold"></i> Trả phòng chuẩn: <?php echo e($footerCheckOut); ?></li>
...
</footer><?php /**PATH C:\xampp\htdocs\booking-web\resources\views/user/partials/footer.blade.php ENDPATH**/ ?>