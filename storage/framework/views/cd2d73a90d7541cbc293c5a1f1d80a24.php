...
<div class="exec-dashboard">
    ...
    <section class="exec-range">
        <form method="GET" action="<?php echo e(route('admin.dashboard')); ?>" class="exec-range-form">
            <div class="field"><label>Từ ngày</label><input type="date" name="from" id="dashboardRangeFrom" class="form-control" value="<?php echo e($from->format('Y-m-d')); ?>"></div>
            <div class="field"><label>Đến ngày</label><input type="date" name="to" id="dashboardRangeTo" class="form-control" value="<?php echo e($to->format('Y-m-d')); ?>"></div>
    ...
    <section class="exec-kpis">
        <a class="exec-kpi" href="<?php echo e(route('admin.dashboard.detail',['metric'=>'revenue','from'=>$from->format('Y-m-d'),'to'=>$to->format('Y-m-d')])); ?>">
            <div class="exec-kpi-icon"><i class="bx bx-wallet"></i></div><div class="label">Tiền đã thu trong kỳ</div><div class="value"><?php echo e($compactMoney($revenue)); ?></div>
            ...
            <div class="sub">Giao dịch thanh toán thành công · kỳ trước: <?php echo e($compactMoney($previousRevenue)); ?> · bấm để xem từng giao dịch</div>
        </a>
        ...
        <a class="exec-kpi" href="<?php echo e(route('admin.dashboard.detail',['metric'=>'occupancy','from'=>$from->format('Y-m-d'),'to'=>$to->format('Y-m-d')])); ?>"><div class="exec-kpi-icon"><i class="bx bx-bed"></i></div><div class="label">Công suất phòng bình quân</div><div class="value"><?php echo e(number_format((float)data_get($occupancy,'rate',0),1,',','.')); ?>%</div><div class="sub"><?php echo e(data_get($occupancy,'occupied_room_days',0)); ?> / <?php echo e(data_get($occupancy,'capacity_room_days',0)); ?> phòng-ngày · bấm để xem từng phòng</div></a>
        ...
        <a class="exec-kpi" href="<?php echo e(route('admin.dashboard.detail',['metric'=>'active_stays','from'=>$from->format('Y-m-d'),'to'=>$to->format('Y-m-d')])); ?>"><div class="exec-kpi-icon"><i class="bx bx-user-check"></i></div><div class="label">Khách đang lưu trú</div><div class="value"><?php echo e($activeGuests); ?></div><div class="sub"><?php echo e($activeStays); ?> booking đang checked-in · bấm để xem danh sách</div></a>
    </section>

    <section class="exec-grid">
        <article class="exec-card">
            <div class="exec-card-head"><div><h2>Xu hướng tiền thu vào</h2><p>Giao dịch thanh toán thành công theo đúng thời điểm thu.</p></div><a class="exec-pill text-decoration-none" href="<?php echo e(route('admin.dashboard.detail',['metric'=>'revenue','from'=>$from->format('Y-m-d'),'to'=>$to->format('Y-m-d')])); ?>">Xem giao dịch</a></div>
        ...
        <article class="exec-card">
            ...
            <div class="exec-room-now"><a class="exec-room-stat text-decoration-none text-dark" href="<?php echo e(route('admin.dashboard.detail',['metric'=>'room_status','group'=>'available','from'=>$from->format('Y-m-d'),'to'=>$to->format('Y-m-d')])); ?>"><strong><?php echo e($currentAvailableRooms); ?></strong><span>Trống</span></a><a class="exec-room-stat text-decoration-none text-dark" href="<?php echo e(route('admin.dashboard.detail',['metric'=>'room_status','group'=>'occupied','from'=>$from->format('Y-m-d'),'to'=>$to->format('Y-m-d')])); ?>"><strong><?php echo e($currentOccupiedRooms); ?></strong><span>Đang ở</span></a><a class="exec-room-stat text-decoration-none text-dark" href="<?php echo e(route('admin.dashboard.detail',['metric'=>'room_status','group'=>'reserved','from'=>$from->format('Y-m-d'),'to'=>$to->format('Y-m-d')])); ?>"><strong><?php echo e((int)($roomStatuses['reserved'] ?? 0)); ?></strong><span>Đã giữ</span></a><a class="exec-room-stat text-decoration-none text-dark" href="<?php echo e(route('admin.dashboard.detail',['metric'=>'room_status','group'=>'not_ready','from'=>$from->format('Y-m-d'),'to'=>$to->format('Y-m-d')])); ?>"><strong><?php echo e($currentNotReadyRooms); ?></strong><span>Chưa sẵn sàng</span></a></div>
            <?php $__empty_1 = true; $__currentLoopData = $categoryRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><a class="exec-progress-row d-block text-decoration-none text-dark" href="<?php echo e(route('admin.dashboard.detail',['metric'=>'category_occupancy','group'=>$row['id'],'from'=>$from->format('Y-m-d'),'to'=>$to->format('Y-m-d')])); ?>"><div class="exec-progress-meta"><strong><?php echo e($row['name']); ?></strong><span><?php echo e($row['rate']); ?>% · <?php echo e($row['room_count']); ?> phòng</span></div><div class="exec-track"><div class="exec-fill" style="width:<?php echo e(max(0,min(100,$row['rate']))); ?>%"></div></div></a><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><div class="exec-empty">Chưa có dữ liệu hạng phòng.</div><?php endif; ?>
        </article>
    </section>
    ...
    <section class="exec-grid equal">
        <article class="exec-card">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $sourceRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><a class="exec-source-row" href="<?php echo e(route('admin.dashboard.detail',['metric'=>'booking_source','group'=>$row['key'],'from'=>$from->format('Y-m-d'),'to'=>$to->format('Y-m-d')])); ?>"><span><?php echo e($row['label']); ?></span><div class="exec-track"><div class="exec-fill lime" style="width:<?php echo e((($row['count']/$sourceMax)*100)); ?>%"></div></div><strong><?php echo e($row['count']); ?></strong></a><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><div class="exec-empty">Chưa có booking trong kỳ.</div><?php endif; ?>
        </article>
        <article class="exec-card">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $surchargeCollection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><a class="exec-money-row" href="<?php echo e(route('admin.dashboard.detail',['metric'=>'surcharges','group'=>$row['key'],'from'=>$from->format('Y-m-d'),'to'=>$to->format('Y-m-d')])); ?>"><span><?php echo e($row['label']); ?></span><div class="exec-track"><div class="exec-fill orange" style="width:<?php echo e((($row['total']/$surchargeMax)*100)); ?>%"></div></div><strong><?php echo e($compactMoney($row['total'])); ?></strong></a><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><div class="exec-empty">Không phát sinh phụ thu trong kỳ.</div><?php endif; ?>
        </article>
    </section>

    <section class="exec-grid equal">
        <article class="exec-card">
            <div class="exec-card-head"><div><h2>Cơ cấu tiền thu vào</h2><p>Phân theo phương thức/provider của giao dịch thành công.</p></div><span class="exec-pill"><?php echo e($compactMoney($grossRevenue)); ?></span></div>
            <?php $__empty_1 = true; $__currentLoopData = $providerCollection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><a class="exec-money-row" href="<?php echo e(route('admin.dashboard.detail',['metric'=>'payment_provider','group'=>$row['key'],'from'=>$from->format('Y-m-d'),'to'=>$to->format('Y-m-d')])); ?>"><span><?php echo e($row['label']); ?></span><div class="exec-track"><div class="exec-fill blue" style="width:<?php echo e((($row['total']/$providerMax)*100)); ?>%"></div></div><strong><?php echo e($compactMoney($row['total'])); ?></strong></a><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><div class="exec-empty">Chưa có khoản thu trong kỳ.</div><?php endif; ?>
        </article>
        <article class="exec-card">
            ...
            <div class="exec-status-grid">
                <?php $__currentLoopData = $statusLabels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status=>$label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <a class="exec-status text-decoration-none text-dark" href="<?php echo e(route('admin.dashboard.detail',['metric'=>'booking_status','group'=>$status,'from'=>$from->format('Y-m-d'),'to'=>$to->format('Y-m-d')])); ?>"><div class="n"><?php echo e($count); ?></div><div class="t"><?php echo e($label); ?> · <?php echo e(number_format(($count/$statusTotal)*100,1,',','.')); ?>%</div></a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </article>
    </section>
