...
<div class="exec-dashboard">
    ...
    <section class="exec-kpis">
        <article class="exec-kpi">
            <div class="exec-kpi-icon"><i class="bx bx-wallet"></i></div><div class="label">Doanh thu thực thu</div><div class="value"><?php echo e($compactMoney($revenue)); ?></div>
            ...
            <div class="sub">So với <?php echo e($previousPeriodLabel); ?>: <?php echo e($compactMoney($previousRevenue)); ?></div>
        </article>
        <article class="exec-kpi"><div class="exec-kpi-icon"><i class="bx bx-receipt"></i></div><div class="label">Giá trị booking phát sinh</div><div class="value"><?php echo e($compactMoney($bookingValue)); ?></div><div class="sub">Không tính booking đã hủy · dựa trên đơn tạo trong kỳ</div></article>
        ...
        <article class="exec-kpi"><div class="exec-kpi-icon"><i class="bx bx-calendar-check"></i></div><div class="label">Booking mới</div><div class="value"><?php echo e($newBookings); ?></div><div class="sub">Hoàn tất/trả phòng: <?php echo e($completedBookings); ?> · Hủy: <?php echo e($cancelledBookings); ?> · No-show: <?php echo e($noShowCount); ?></div></article>
        <article class="exec-kpi"><div class="exec-kpi-icon"><i class="bx bx-credit-card"></i></div><div class="label">Công nợ liên quan kỳ</div><div class="value"><?php echo e($compactMoney($receivableAmount)); ?></div><div class="sub"><?php echo e($receivableBookings); ?> booking còn số tiền phải thu</div></article>
        <article class="exec-kpi"><div class="exec-kpi-icon"><i class="bx bx-purchase-tag-alt"></i></div><div class="label">Ưu đãi / giảm giá</div><div class="value"><?php echo e($compactMoney($discountAmount)); ?></div><div class="sub">Tổng discount snapshot của booking tạo trong kỳ</div></article>
    </section>

    <section class="exec-grid">
        <article class="exec-card">
            <div class="exec-card-head"><div><h2>Xu hướng doanh thu thực thu</h2><p>Chỉ cộng giao dịch payment có trạng thái thành công trong khoảng đã chọn.</p></div><span class="exec-pill"><?php echo e($periodLabel); ?></span></div>
    ...
    <section class="exec-grid equal">
        <article class="exec-card">
            <div class="exec-card-head"><div><h2>Cơ cấu tiền đã thu</h2><p>Phân theo phương thức/provider của giao dịch thành công.</p></div><span class="exec-pill"><?php echo e($compactMoney($revenue)); ?></span></div>
