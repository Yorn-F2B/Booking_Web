...
<div class="row g-2 staying-guest-form" data-guest-form data-editing-guest-id="<?php echo e($editingGuest?->id); ?>">
    ...
    <div class="col-md-3">
        ...
        <select name="document_type" id="<?php echo e($fieldPrefix); ?>document_type" class="form-select form-select-sm" data-document-type>
    ...
    <div class="col-md-3">
        ...
        <input type="text" name="document_number" id="<?php echo e($fieldPrefix); ?>document_number" class="form-control form-control-sm" value="<?php echo e(old('document_number', $editingGuest?->document_number ?? $editingGuest?->cccd)); ?>" maxlength="50">
    </div>
...
<?php if (! $__env->hasRenderedOnce('2a9e1dec-2f10-4a16-8660-0003f8f23423')): $__env->markAsRenderedOnce('2a9e1dec-2f10-4a16-8660-0003f8f23423'); ?>
<script>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Booking_Web-master\Booking_Web-master\resources\views\admin\pages\bookings\partials\staying-guest-fields.blade.php ENDPATH**/ ?>