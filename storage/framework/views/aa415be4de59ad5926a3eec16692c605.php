<?php $__env->startSection('title', 'Thêm mã ưu đãi'); ?>
    ...
    <div class="admin-wrapper">
        <main class="admin-content">
            ...
            <div class="admin-page-head">
                <div>
                    <h2>Thêm mã ưu đãi</h2>
                    <p>Tạo mã thường, mã sự kiện, mã hỗ trợ hoặc mã điều kiện</p>
                </div>
            ...
            <?php if($errors->any()): ?>
                <div class="alert alert-danger">
                    <strong>Không thể lưu mã:</strong>
                    <ul class="mb-0 mt-2">
            ...
            <form action="<?php echo e(route('admin.promotions.store')); ?>" method="POST" id="promotionForm">
                <?php echo csrf_field(); ?>
<?php if (! $__env->hasRenderedOnce('baa2c20d-09d1-459f-af00-ff1e6a04e2ee')): $__env->markAsRenderedOnce('baa2c20d-09d1-459f-af00-ff1e6a04e2ee'); ?>
    <style>
        .flatpickr-calendar {
            font-family: inherit;
            border-radius: 14px;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Booking_Web-master\Booking_Web-master\resources\views\admin\pages\promotions\create.blade.php ENDPATH**/ ?>