...
<?php $__env->startSection('content'); ?>
    ...
    <div class="admin-wrapper room-management">
        <main class="admin-content">
            ...
            <div class="rm-alert rm-alert-success"><?php echo e(session('success')); ?></div><?php endif; ?>
            <?php if(session('error')): ?>
            <div class="rm-alert rm-alert-error"><?php echo e(session('error')); ?></div><?php endif; ?>
            <?php if($errors->any()): ?>
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td><span class="status-pill s-<?php echo e($room->status); ?>"><i
                                                class="rm-dot"></i><?php echo e($physicalStatusLabels[$room->status] ?? $room->status); ?></span>
                                    </td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Booking_Web-master\Booking_Web-master\resources\views\admin\pages\rooms\index.blade.php ENDPATH**/ ?>