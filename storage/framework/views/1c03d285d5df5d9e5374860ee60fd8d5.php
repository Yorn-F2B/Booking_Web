        ...
        <details class="compact-panel mb-3" <?php if($stage === 'guest_consultation'): ?> open <?php endif; ?>>
            ...
            <div class="compact-panel-body">
                                            ...
                                            <td>
                                                ...
                                                <?php if(($item->detection_source ?? 'initial') === 'supplemental'): ?>
                                                    ...
                                                    <div class="small text-muted mt-1">
                                                        <?php echo e($item->detector->name ?? 'Buồng phòng'); ?> · <?php echo e($item->detected_at?->format('d/m H:i') ?? $item->created_at?->format('d/m H:i')); ?>
                ...
                <?php elseif($stage === 'completed'): ?>
                    <div class="alert alert-success mb-0">Kết quả đã thống nhất và phiếu đã hoàn tất. Tổng phí kiểm tra phòng được chốt: <strong><?php echo e(number_format((float)$inspection->approved_total,0,',','.')); ?>đ</strong>.</div>
                <?php else: ?>
...
<?php /**PATH C:\xampp\htdocs\booking-web\resources\views/admin/pages/bookings/partials/inspection-guest-consultation.blade.php ENDPATH**/ ?>