        ...
        <div class="card-body p-4">
            ...
            <form id="lateArrivalRequestForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="expectedArrivalDate" name="expected_arrival_date" type="date" class="form-control" required
                            data-year-select value="<?php echo e($oldArrivalDate); ?>" min="<?php echo e(\Carbon\Carbon::parse($booking->check_in_date)->format('Y-m-d')); ?>">
                    </div>
                    <div class="col-md-6">
                        ...
                        <input id="expectedArrivalTime" name="expected_arrival_time" type="text" class="form-control" required
                            data-project-time-picker value="<?php echo e($oldArrivalTime); ?>" placeholder="HH:mm">
                    </div>
                    <div class="col-12">
                        <label class="form-label">Lý do đến muộn <span class="text-danger">*</span></label>
                        <textarea name="reason" rows="4" class="form-control" required maxlength="2000" placeholder="Ví dụ: chuyến xe bị chậm, máy bay hoãn chuyến..."><?php echo e(old('reason', $pendingRequest?->reason)); ?></textarea>
                    </div>
                            ...
                            <div class="row g-2" id="existingLateArrivalAttachments">
                                <?php $__currentLoopData = $pendingRequest->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        ...
                                        $fileUrl = route('bookings.customer-requests.attachment', [$booking, $attachment]);
                                    ?>
                                    <div class="col-6 col-md-3 js-existing-attachment" data-attachment-id="<?php echo e($attachment->id); ?>">
                                        <div class="border rounded p-2 h-100 position-relative bg-white">
                                            ...
                                            <?php else: ?>
                                                <a href="<?php echo e($fileUrl); ?>" target="_blank" class="d-flex align-items-center justify-content-center text-decoration-none" style="height:110px"><strong>PDF</strong></a>
                                            <?php endif; ?>
                ...
                <div class="d-flex gap-2 mt-4">
                    <button class="btn btn-primary"><?php echo e($pendingRequest ? 'Cập nhật yêu cầu' : 'Gửi yêu cầu'); ?></button>
                    <a href="<?php echo e(route('bookings.show', $booking)); ?>" class="btn btn-outline-secondary">Quay lại booking</a>
                </div>
            </form>
        </div>
    </div>
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Booking_Web-master\Booking_Web-master\resources\views\user\customer-requests\form.blade.php ENDPATH**/ ?>