...
<div class="container py-4" style="max-width:820px">
    <div class="card shadow-sm">
        <div class="card-body p-4">
            ...
            <p class="text-muted">Booking <strong><?php echo e($booking->booking_code); ?></strong> · Giờ G: <?php echo e($lateArrivalCutoffLabel); ?> ngày nhận phòng.</p>
...
<?php echo $__env->make('guest-bookings.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\booking-web\resources\views/guest-customer-requests/form.blade.php ENDPATH**/ ?>