    ...
    <div class="admin-wrapper">
        ...
        <main class="admin-content">
            ...
            <div class="admin-page-head">
                ...
                <?php if(in_array(auth()->user()?->role, ['super_admin', 'manager'], true)): ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <?php elseif($room->status == 'inspection'): ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\booking-web\resources\views/admin/pages/rooms/show.blade.php ENDPATH**/ ?>