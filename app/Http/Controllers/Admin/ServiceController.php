...
class ServiceController extends Controller
{
    public function index(Request $request)
    {
        ...
        $services = $query
            ->orderByRaw("FIELD(type, 'service', 'minibar_order', 'minibar', 'damage_fee', 'extra_guest_fee', 'early_checkin_fee', 'late_checkout_fee', 'extension_fee', 'policy_violation_fee', 'manual_fee', 'occupancy_fee')")
    ...
    private function validatedServiceData(Request $request): array
    {
        ...
        if (!in_array($data['type'], [Service::TYPE_SERVICE, Service::TYPE_MINIBAR_ORDER], true)) {
