...
class BookingFinancialService
{
    ...
    public function currentTotal(Booking $booking): float
    {
        ...
        // Lấy danh sách phiếu kiểm tra phòng có trạng thái 'confirmed'
        ...
        // Dịch vụ: tính các khoản confirmed và loại bỏ khoản minibar/damage_fee trùng với kiểm tra phòng đã duyệt
        ...
        // Phí kiểm tra phòng: Chỉ lấy các khoản đã duyệt thuộc phiếu kiểm tra phòng 'confirmed' (kết quả mới nhất đã duyệt)
